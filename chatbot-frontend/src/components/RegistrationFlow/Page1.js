...
const Page3 = () => {
  ...
  const handleStartChat = async () => {
    try {
      ...
      await apiClient.put("/auth/update-user", userData, {
      ...
      const aiAgentPayload = {
        ...
        city: city,
        image_url: imageURL,
        relationship_type: aiAgentData.relationship_type,
        agent_gender: aiAgentData.agent_gender,
      };

      await apiClient.post("/agents", aiAgentPayload, {
        headers: { Authorization: `Bearer ${token}` },
      });
